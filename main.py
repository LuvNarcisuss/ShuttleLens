...
def main():
    ...
    parser.add_argument('--video-path', default='demo_file/videos/demo.mp4', type=str, help='输入视频文件路径')
    parser.add_argument('--template-path', default='demo_file/templates/demo.png', type=str, help='球场模板图像路径；不提供时会弹出文件选择框')
